...
def sum_two_numbers(a, b):
    return a + b
#In this exercise you'll use an existing function, and
#  while adding your own to create a fully functional program.

#    Add a function named list_benefits() that returns the following
#  list of strings: "More organized code", "More readable code", "Easier code reuse",
...
def build_sentence(benefit):
    #newlist = object()
    #for b in benefit:
    #    newlist.append(b+" is a benefit of functions!")
    #return newlist
